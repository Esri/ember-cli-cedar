...
a&&a.handleMouseMove&&a.handleMouseMove(e)}},t.handleWheel=function(e){for(var i=t.charts,s=0;s<i.length;s++){var a=i[s]
if(a&&a.mouseIsOver){(a.mouseWheelScrollEnabled||a.mouseWheelZoomEnabled)&&a.handleWheel&&a.handleWheel(e)
...
break
case"gantt":a=new t.AmGanttChart(r)}return t.extend(a,i),t.isReady?isNaN(s)?a.write(e):setTimeout(function(){t.realWrite(a,e)},s):t.ready(function(){isNaN(s)?a.write(e):setTimeout(function(){t.realWrite(a,e)},s)}),a},t.realWrite=function(t,e){t.write(e)},t.updateCount=0
...
var e=t.graphics.getBBox(),i=this.x+e.x+e.width/2,s=(e=this.y+e.y+e.height/2,t.fillColor)
...
if(!(1<Math.abs(s-r)))if(1>t){if((r=Math.pow(10,-r)*h)==Math.round(r))return h}else if(h==Math.round(h))return h}},stackGraphs:function(e){var i=this.stackType
...
this.set=b
var x=e.axisThickness,N=e.axisColor,C=e.axisAlpha,y=e.tickLength,w=e.gridAlpha,M=e.gridThickness,A=e.gridColor,S=e.dashLength,D=e.fillColor,T=e.fillAlpha,L=e.labelsEnabled
u=e.labelRotationR
...
X>j&&(X=j)
var Z,q,_,K=v,J=g,Q=0,$=0,tt=0,et=0,it=0,st=0,at=this.fillColorsR,ht=this.negativeFillColors,rt=this.negativeLineColor,nt=this.fillAlphas,ot=this.negativeFillAlphas
...
x?(K=v,J=Math.abs(pt-ct),tt=v,et=Math.abs(dt-ct),st=$=0,r.reversed?(Q=0,it=ct):(Q=ct,it=0)):(J=g,K=Math.abs(pt-ct),et=g,tt=Math.abs(dt-ct),it=Q=0,r.reversed?(st=b,$=ct):st=ct)}var mt=Math.round
this.pmx=mt(Q),this.pmy=mt($),this.pmh=mt(K),this.pmw=mt(J),this.nmx=mt(it),this.nmy=mt(st),this.nmh=mt(tt),this.nmw=mt(et),t.isModern||(this.nmy=this.nmx=0,this.nmh=this.height),this.clustered||(N=1),1>(o="column"==n?(U*o-X*(N-1))/N:U*o)&&(o=1)
var ft,gt=this.fixedColumnWidth
if(isNaN(gt)||(o=gt),"line"==n||"step"==n||"smoothedLine"==n){if(0<L){for(ft=L-1;-1<ft;ft--)if(Z=a[ft],q=Z.axes[r.id].graphs[i],_=q.values.value,!isNaN(_)){L=ft
break}if(this.lineColorField)for(ft=L;-1<ft;ft--)if(Z=a[ft],q=Z.axes[r.id].graphs[i],q.lineColor){this.lineColorSwitched=q.lineColor,void 0===this.bulletColor&&(this.bulletColorSwitched=this.lineColorSwitched)
break}if(this.fillColorsField)for(ft=L;-1<ft;ft--)if(Z=a[ft],q=Z.axes[r.id].graphs[i],q.fillColors){this.fillColorsSwitched=q.fillColors
break}if(this.dashLengthField)for(ft=L;-1<ft;ft--)if(Z=a[ft],q=Z.axes[r.id].graphs[i],!isNaN(q.dashLength)){this.dashLengthSwitched=q.dashLength
break}}if(k<a.length-1)for(ft=k+1;ft<a.length;ft++)if(Z=a[ft],q=Z.axes[r.id].graphs[i],_=q.values.value,!isNaN(_)){k=ft
break}}k<a.length-1&&k++
var vt=[],bt=[],xt=!1
"line"!=n&&"step"!=n&&"smoothedLine"!=n||(this.stackable&&"regular"==T||"100%"==T||this.fillToGraph)&&(xt=!0)
var Nt=this.noStepRisers,Ct=-1e3,yt=-1e3,wt=this.minDistance,Mt=!0,At=!1
for(ft=L;ft<=k;ft++){(q=(Z=a[ft]).axes[r.id].graphs[i]).index=ft
var St,Dt=NaN
if(f&&void 0==this.openField)for(var Tt=ft+1;Tt<a.length&&(!a[Tt]||!(St=a[ft+1].axes[r.id].graphs[i])||!St.values||(Dt=St.values.value,isNaN(Dt)));Tt++);var Lt,kt,Bt,Rt,Ot,Et,It=NaN,Gt=NaN,Ft=NaN,zt=NaN,Pt=NaN,Wt=NaN,Yt=NaN,Ht=NaN,Vt=NaN,Xt=NaN,Ut=NaN,jt=NaN,Zt=NaN,qt=NaN,_t=NaN,Kt=NaN,Jt=NaN,Qt=void 0,$t=at,te=nt,ee=W,ie=this.proCandlesticks,se=this.topRadius,ae=v-1,he=g-1,re=this.pattern
void 0!=q.pattern&&(re=q.pattern),isNaN(q.alpha)||(te=q.alpha),isNaN(q.dashLength)||(Y=q.dashLength)
var ne=q.values
if(r.recalculateToPercents&&(ne=q.percents),"none"==T&&(F=isNaN(q.columnIndex)?this.columnIndex:q.columnIndex),ne){if(qt=this.stackable&&"none"!=T&&"3d"!=T?ne.close:ne.value,"candlestick"!=n&&"ohlc"!=n||(qt=ne.close,Kt=ne.low,Yt=r.getCoordinate(Kt),_t=ne.high,Vt=r.getCoordinate(_t)),Jt=ne.open,Ft=r.getCoordinate(qt,lt),isNaN(Jt)||(Pt=r.getCoordinate(Jt,lt),f&&"regular"!=T&&"100%"!=T&&(Dt=Jt,Jt=Pt=NaN)),f&&(void 0==this.openField?St&&(St.isNegative=Dt<qt,isNaN(Dt)&&(q.isNegative=!Mt)):q.isNegative=Dt>qt),!B)switch(this.showBalloonAt){case"close":q.y=Ft
break
case"open":q.y=Pt
break
case"high":q.y=Vt
...
var Ce,ye
if(Lt=zt,(kt=Ft-o/2)+(Bt=o)>v&&(Bt=v-kt),0>kt&&(Bt+=kt,kt=0),kt<v&&0<Bt)qt>Jt?(Ce=[Gt,Ht],ye=[zt,Wt]):(Ce=[zt,Ht],ye=[Gt,Wt]),!isNaN(Ht)&&!isNaN(Wt)&&Ft<v&&0<Ft&&(xe=t.line(h,Ce,[Ft,Ft],Ot,P,z),Ne=t.line(h,ye,[Ft,Ft],Ot,P,z)),Rt=Gt-zt,Qt=new t.Cuboid(h,Rt,Bt,S,D,$t,nt,z,Ot,P,V,C,x,Y,re,se,R)}else{if("open"==l&&(Zt=Pt),"high"==l&&(Zt=Vt),"low"==l&&(Zt=Yt),Ft=t.fitToBounds(Ft,0,ae),Pt=t.fitToBounds(Pt,0,ae),Yt=t.fitToBounds(Yt,0,ae),Vt=t.fitToBounds(Vt,0,ae),0===Ft&&0===Pt&&0===Yt&&0===Vt)continue
if(Ft==ae&&Pt==ae&&Yt==ae&&Vt==ae)continue
if(kt=Pt+z/2,(Lt=Gt-o/2)+(Bt=o)>g&&(Bt=g-Lt),0>Lt&&(Bt+=Lt,Lt=0),Rt=Ft-Pt,Lt<g&&0<Bt){ie&&qt>=Jt&&(te=0)
var we,Me
Qt=new t.Cuboid(h,Bt,Rt,S,D,$t,te,z,Ot,P,V,C,x,Y,re,se,R)
qt>Jt?(we=[Ft,Vt],Me=[Pt,Yt]):(we=[Pt,Vt],Me=[Ft,Yt]),!isNaN(Vt)&&!isNaN(Yt)&&Gt<g&&0<Gt&&(xe=t.line(h,[Gt,Gt],we,Ot,P,z),Ne=t.line(h,[Gt,Gt],Me,Ot,P,z),t.setCN(e,xe,this.bcn+"line-high"),q.className&&t.setCN(e,xe,q.className,!0),t.setCN(e,Ne,this.bcn+"line-low"),q.className&&t.setCN(e,Ne,q.className,!0))}}Qt&&(Et=Qt.set,q.columnGraphics=Et,H.push(Et),Et.translate(Lt,kt-z/2),(q.url||this.showHandOnHover)&&Et.setAttr("cursor","pointer"),xe&&(H.push(xe),H.push(Ne)),B||(q.x=x?kt+Bt/2:Lt+Bt/2,this.animateColumns(Qt,ft,Gt,zt,Ft,Pt),this.addListeners(Et,q),void 0!==this.tabIndex&&Et.setAttr("tabindex",this.tabIndex)))}break
case"ohlc":if(!(isNaN(Jt)||isNaN(_t)||isNaN(Kt)||isNaN(qt))){var Ae,Se,De,Te=h.set()
if(H.push(Te),qt<Jt&&(q.isNegative=!0,void 0!=rt&&(ee=rt)),void 0!=q.lineColor&&(ee=q.lineColor),x){if(Zt=Ft,jt=Gt,"open"==l&&(jt=zt),"high"==l&&(jt=Ht),"low"==l&&(jt=Wt),Wt=t.fitToBounds(Wt,0,he),Ht=t.fitToBounds(Ht,0,he),0===Gt&&0===zt&&0===Wt&&0===Ht)continue
if(Gt==he&&zt==he&&Wt==he&&Ht==he)continue
var Le=Ft-o/2,ke=(Le=t.fitToBounds(Le,0,v),t.fitToBounds(Ft,0,v)),Be=Ft+o/2
Be=t.fitToBounds(Be,0,v)
0<=zt&&zt<=he&&(Se=t.line(h,[zt,zt],[Le,ke],ee,P,z,Y)),0<Ft&&Ft<v&&(Ae=t.line(h,[Wt,Ht],[Ft,Ft],ee,P,z,Y)),0<=Gt&&Gt<=he&&(De=t.line(h,[Gt,Gt],[ke,Be],ee,P,z,Y))}else{Zt=Ft,"open"==l&&(Zt=Pt),"high"==l&&(Zt=Vt),"low"==l&&(Zt=Yt)
...
0<=Pt&&Pt<=ae&&(Se=t.line(h,[Re,Oe],[Pt,Pt],ee,P,z,Y)),0<Gt&&Gt<g&&(Ae=t.line(h,[Gt,Gt],[Yt,Vt],ee,P,z,Y)),0<=Ft&&Ft<=ae&&(De=t.line(h,[Oe,Ee],[Ft,Ft],ee,P,z,Y))}H.push(Se),H.push(Ae),H.push(De),t.setCN(e,Se,this.bcn+"stroke-open"),t.setCN(e,De,this.bcn+"stroke-close"),t.setCN(e,Ae,this.bcn+"stroke"),q.className&&t.setCN(e,Te,q.className,!0),Ae&&this.addListeners(Ae,q),De&&this.addListeners(De,q),Se&&this.addListeners(Se,q),Xt=Gt,Ut=Ft}}if(!B&&!isNaN(qt)){var Ie=this.hideBulletsCount
...
Ge&&(Pe=Ge.size),this.positionLabel(q,Xt,Ut,ze,Pe)}if("regular"==T||"100%"==T){var We=r.totalText
...
qe&&qe.remove()
var _e=0
"column"!=n&&(_e=this.bulletSize),x?(Ve=Ut,He=0>qt?Gt-Ue/2-2-_e-Ze:Gt+Ue/2+3+_e+Ze):(He=Xt,Ve=0>qt?Ft+je/2+_e+Ze:Ft-je/2-3-_e-Ze),Ye.translate(He,Ve),r.totals[ft]=Ye,x?(0>Ve||Ve>v)&&Ye.remove():(0>He||He>g)&&Ye.remove()}}}}}}}this.lastDataItem=q,"line"!=n&&"step"!=n&&"smoothedLine"!=n||("smoothedLine"==n?this.drawSmoothedGraph(w,M,vt,bt):this.drawLineGraph(w,M,vt,bt),B||this.launchAnimation()),this.bulletsHidden&&this.hideBullets(),this.customBulletsHidden&&this.hideCustomBullets()},animateColumns:function(t,e){var i=this,s=i.chart.startDuration
...
i&&(i.remove(),s=i.y),(i=this.container.set()).translate(0,s),(s=t.rect(this.container,this.width,e,this.cursorColor,this.cursorAlpha)).translate(0,-e/2),i.push(s),this.fullLines.push(i),this.hhLine=i,this.prevLineHeight=e}},fixVLine:function(t,e){if(!isNaN(t)){if(isNaN(this.prevLineX)){var i=0,s=this.mouseX
...
this.fx=t,this.prevLineX!=t&&(i=this.animationDuration,this.zooming&&(i=0),this.vvLine.stop(),this.vvLine.animate({translate:t+","+e},i,"easeOutSine"),this.prevLineX=t,this.prevLineY=e)}},fixHLine:function(t,e){if(!isNaN(t)){if(isNaN(this.prevLineY)){var i=0,s=this.mouseY
if(this.limitToGraph){var a=this.chart.categoryAxis
...
for(y.axes[D]={},y.axes[D].graphs={},S=0;S<h.length;S++){var T=(i=h[S]).id,L=1.1
isNaN(i.gapPeriod)||(L=i.gapPeriod)
var k=i.periodValue
if(i.valueAxis.id==D){y.axes[D].graphs[T]={}
var B={}
B.index=x
var R=w
if(i.dataProvider&&(R=r),B.values=this.processValues(R,i,k),!i.connect||i.forceGap&&!isNaN(i.gapPeriod))if(C&&C[T]&&0<L&&y.time-v[T]>=g*L&&(C[T].gap=!0),i.forceGap){var O
L=0
for(O in B.values)L++
0<L&&(v[T]=y.time,C[T]=B)}else v[T]=y.time,C[T]=B
this.processFields(i,B,R),B.category=y.category,B.serialDataItem=y,B.graph=i,y.axes[D].graphs[T]=B}}}this.chartData[x]=y}}if(this.parseCount==a){for(e=0;e<h.length;e++)i=h[e],i.dataProvider&&this.parseGraphData(i)
...
var b,x,N=1/180*Math.PI,C=i+Math.sin(a*N)*o,y=s-Math.cos(a*N)*g,w=i+Math.sin(a*N)*r,M=s-Math.cos(a*N)*n,A=i+Math.sin((a+h)*N)*r,S=s-Math.cos((a+h)*N)*n,D=i+Math.sin((a+h)*N)*o,T=(N=s-Math.cos((a+h)*N)*g,{fill:t.adjustLuminosity(d.fill,-.2),"stroke-opacity":0,"fill-opacity":d["fill-opacity"]}),L=0
if(180<Math.abs(h)&&(L=1),a=e.set(),v&&(C=f(10*C),w=f(10*w),A=f(10*A),D=f(10*D),y=f(10*y),M=f(10*M),S=f(10*S),N=f(10*N),i=f(10*i),l=f(10*l),s=f(10*s),r*=10,n*=10,o*=10,g*=10,1>Math.abs(h)&&1>=Math.abs(A-w)&&1>=Math.abs(S-M)&&(b=!0)),h="",c&&(T["fill-opacity"]=0,T["stroke-opacity"]=d["stroke-opacity"]/2,T.stroke=d.stroke),0<l){x=" M"+C+","+(y+l)+" L"+w+","+(M+l),v?(b||(x+=" A"+(i-r)+","+(l+s-n)+","+(i+r)+","+(l+s+n)+","+w+","+(M+l)+","+A+","+(S+l)),x+=" L"+D+","+(N+l),0<o&&(b||(x+=" B"+(i-o)+","+(l+s-g)+","+(i+o)+","+(l+s+g)+","+D+","+(l+N)+","+C+","+(l+y)))):(x+=" A"+r+","+n+",0,"+L+",1,"+A+","+(S+l)+" L"+D+","+(N+l),0<o&&(x+=" A"+o+","+g+",0,"+L+",0,"+C+","+(y+l))),x+=" Z"
var k=l
v&&(k/=10)
for(var B=0;B<k;B+=10){var R=e.path(x,void 0,void 0,"1000,1000").attr(T)
a.push(R),R.translate(0,-B)}x=e.path(" M"+C+","+y+" L"+C+","+(y+l)+" L"+w+","+(M+l)+" L"+w+","+M+" L"+C+","+y+" Z",void 0,void 0,"1000,1000").attr(T),l=e.path(" M"+A+","+S+" L"+A+","+(S+l)+" L"+D+","+(N+l)+" L"+D+","+N+" L"+A+","+S+" Z",void 0,void 0,"1000,1000").attr(T),a.push(x),a.push(l)}if(v?(b||(h=" A"+f(i-r)+","+f(s-n)+","+f(i+r)+","+f(s+n)+","+f(w)+","+f(M)+","+f(A)+","+f(S)),n=" M"+f(C)+","+f(y)+" L"+f(w)+","+f(M)+h+" L"+f(D)+","+f(N)):n=" M"+C+","+y+" L"+w+","+M+" A"+r+","+n+",0,"+L+",1,"+A+","+S+" L"+D+","+N,0<o&&(v?b||(n+=" B"+(i-o)+","+(s-g)+","+(i+o)+","+(s+g)+","+D+","+N+","+C+","+y):n+=" A"+o+","+g+",0,"+L+",0,"+C+","+y),e.handDrawn&&(o=t.line(e,[C,w],[y,M],d.stroke,d.thickness*Math.random()*e.handDrawThickness,d["stroke-opacity"]),a.push(o)),e=e.path(n+" Z",void 0,void 0,"1000,1000").attr(d),u){for(o=[],g=0;g<u.length;g++)o.push(t.adjustLuminosity(d.fill,u[g]))
...
if(!1!==e.visibleInLegend&&!e.hideFromLegend){var h=i.maxLabelWidth
i.forceWidth&&(h=i.labelWidth),i.equalWidths||(i.valueAlign="left"),"left"==i.valueAlign&&e.legendLabel&&(h=e.legendLabel.getBBox().width)
var r=h
if(i.valueText&&0<i.valueWidth){var n=i.color
i.useMarkerColorForValues&&(n=e.color,e.legendKeyColor&&(n=e.legendKeyColor())),!0===e.hidden&&(n=i.markerDisabledColor)
var o=i.valueText,l=(h=h+i.lx+i.labelDx+i.markerLabelGap+i.valueWidth,"end")
"left"==i.valueAlign&&(h-=i.valueWidth,l="start"),n=t.text(i.container,o,n,i.chart.fontFamily,s,l),t.setCN(a,n,"legend-value"),n.translate(h,i.ly),i.entries[i.index].push(n),r+=i.valueWidth+2*i.markerLabelGap,n.dItem=e,i.valueLabels.push(n)}i.index++,(a=i.markerSize)<s+7&&(a=s+7,t.VML&&(a+=3)),(s=i.container.rect(e.legendEntryWidth,0,r,a,0,0).attr({stroke:"none",fill:"#fff","fill-opacity":.005})).dItem=e,i.entries[i.index-1].push(s),s.mouseover(function(t){i.rollOverLabel(e,t)}).mouseout(function(t){i.rollOutLabel(e,t)}).click(function(t){i.clickLabel(e,t)})}},createV:function(){var e=this.markerSize
...
break
case"MM":i=e.getMonth(),e.setMonth(e.getMonth()+s*r),e.getMonth()>i+s*r&&e.setDate(e.getDate()-1),a||h||e.setDate(e.getDate()+1)
break
