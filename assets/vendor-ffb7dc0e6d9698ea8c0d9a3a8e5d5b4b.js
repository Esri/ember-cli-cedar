...
var i=e.bbox.split(",")
delete e.bbox,e.geometry=JSON.stringify({xmin:Number(i[0]),ymin:Number(i[1]),xmax:Number(i[2]),ymax:Number(i[3])}),e.inSR="4326"}for(var r in e)if(e.hasOwnProperty(r)){var n=e[r]
t[r]="object"==typeof n?JSON.stringify(n):n}return t}(i.query)
