...
Object.defineProperty(e,"__esModule",{value:!0})
var n=Ember.$
e.default=t.default?najax:n.ajax}),define("ember-cli-cedar/components/cedar-chart/component",["exports","@esri/cedar"],function(e,t){"use strict"
...
this.chart=new t.Chart(this.elementId,r)}catch(e){return void this._handleErr(e)}this.get("cedarLoader").loadDependencies().then(function(){if(!e.get("isDestroyed")&&!e.get("isDestroying")){Ember.tryInvoke(e,"onUpdateStart")
...
if(!t)throw e
t(e)},didReceiveAttrs:function(){this._super.apply(this,arguments),Ember.run.scheduleOnce("afterRender",this,"_showChart")},willDestroyElement:function(){this._destroyChart()}})}),define("ember-cli-cedar/instance-initializers/cedar",["exports","fetch","@esri/cedar"],function(e,t,n){"use strict"
function r(){n.default.config&&(n.default.config.fetch=t.default)}Object.defineProperty(e,"__esModule",{value:!0}),e.initialize=r,e.default={initialize:r}}),define("ember-cli-cedar/services/cedar-loader",["exports","@esri/cedar","ember-cli-cedar/utils/lazy-loading"],function(e,t,n){"use strict"
...
t.onload=e,t.rel="stylesheet",t.type="text/css",t.href=n,document.head.appendChild(t)}))}))})}})
...
a.hasOwnProperty("visible")&&(e.legend.enabled=a.visible,e.legend.tabIndex=0),a.position&&["top","bottom","left","right"].indexOf(a.position)>-1&&(e.legend.position=a.position)}if(t.style){var s=t.style
...
t.series.forEach(function(o,s){if(i.name===o.source){var u=l(n)
u.title=o.value.label,u.valueField=r?a+"_"+o.value.field:o.value.field,u.balloonText="<div>"+o.category.label+": [["+e.categoryField+"]]</div><div>"+u.title+": [["+u.valueField+"]]</div>",o.stack&&u.newStack&&(u.newStack=!1),"pie"===t.type&&(e.titleField=e.categoryField,e.valueField=u.valueField),"xy"===e.type&&o.category&&o.value&&(u.xField=o.category.field,u.yField=o.value.field,u.balloonText="<div>"+o.category.label+": [["+o.category.field+"]]</div><div>"+o.value.label+": [["+o.value.field+"]]</div>","xy"===e.type&&o.size?(u.valueField=o.size.field,u.balloonText=u.balloonText+"<div>"+o.size.label+": [["+u.valueField+"]]</div>"):delete u.valueField),e.graphs.push(u)}})}),e}function c(e){var t=e
return"time"===t?(console.warn("'time' is no longer a supported type. Please use 'timeline' instead"),t="timeline"):"bubble"===t?(console.warn("'bubble' is no longer a supported type. Please use 'scatter' instead"),t="scatter"):"grouped"===t&&(console.warn("'grouped' is no longer a supported type. Please use 'bar' instead"),t="bar"),l(s[t])}function l(e){return JSON.parse(JSON.stringify(e))}var f=function(e,t,n){if("custom"===t.type)return AmCharts.makeChart(e,t.specification)
var r=t.specification&&"string"!=typeof t.specification?l(t.specification):c(t.type),i=l(n)
r.dataProvider=i,t.datasets&&(r=u(r,t)),t.overrides&&(r=a(r,t.overrides,{clone:!0}))
var o,s=AmCharts.makeChart(e,r)
return"pie"===t.type&&(s.balloonText="<div>"+((o=t).series[0].category.label?o.series[0].category.label+": ":"")+"[[title]]</div><div>"+(o.series[0].value.label?o.series[0].value.label+": ":"")+"[[percents]]% ([[value]])</div>"),s}
function p(e){return e.features?e.features:e}function h(e){return e.attributes?e.attributes:e}function d(e,t,n){var r=e.name||n
return e.data||t[r]}var m=function(e,t){return(m=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,t){e.__proto__=t}||function(e,t){for(var n in t)t.hasOwnProperty(n)&&(e[n]=t[n])})(e,t)},g=function(){return(g=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++)for(var i in t=arguments[n])Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i])
return e}).apply(this,arguments)}
function v(e){return Object.keys(e).some(function(t){var n=e[t]
if(!n)return!1
switch(n&&n.toParam&&(n=n.toParam()),n.constructor.name){case"Array":case"Object":case"Date":case"Function":case"Boolean":case"String":case"Number":return!1
default:return!0}})}function y(e){var t={}
return Object.keys(e).forEach(function(n){var r=e[n]
if(r&&r.toParam&&(r=r.toParam()),r||0===r||"boolean"==typeof r||"string"==typeof r){var i
...
case"Boolean":i=r+""
break
default:i=r}(i||0===i||"string"==typeof i)&&(t[n]=i)}}),t}function b(e){var t=y(e)
return Object.keys(t).map(function(e){return n=e,r=t[e],encodeURIComponent(n)+"="+encodeURIComponent(r)
var n,r}).join("&")}var _=function(e,t,n,r,i){e=e||"UNKNOWN_ERROR",t=t||"UNKNOWN_ERROR_CODE",this.name="ArcGISRequestError",this.message="UNKNOWN_ERROR_CODE"===t?e:t+": "+e,this.originalMessage=e,this.code=t,this.response=n,this.url=r,this.options=i}
_.prototype=Object.create(Error.prototype),_.prototype.constructor=_
var w,x,E=function(e){function t(t,n,r,i,o){void 0===t&&(t="AUTHENTICATION_ERROR"),void 0===n&&(n="AUTHENTICATION_ERROR_CODE")
var a=e.call(this,t,n,r,i,o)||this
return a.name="ArcGISAuthError",a.message="AUTHENTICATION_ERROR_CODE"===n?t:n+": "+t,a}return function(e,t){function n(){this.constructor=e}m(e,t),e.prototype=null===t?Object.create(t):(n.prototype=t.prototype,new n)}(t,e),t.prototype.retry=function(e,t){var n=this
void 0===t&&(t=3)
var r=0,i=function(o,a){e(n.url,n.options).then(function(e){var t=g({},n.options,{authentication:e})
return r+=1,C(n.url,t)}).then(function(e){o(e)}).catch(function(e){"ArcGISAuthError"===e.name&&r<t?i(o,a):"ArcGISAuthError"===e.name&&r>=t?a(n):a(e)})}
return new Promise(function(e,t){i(e,t)})},t}(_),O="@esri/arcgis-rest-js",S={httpMethod:"POST",params:{f:"json"}}
function C(e,t){void 0===t&&(t={params:{f:"json"}})
var n=g({httpMethod:"POST"},S,t,{params:g({},S.params,t.params),headers:g({},S.headers,t.headers)}),r=[],i=[]
...
var o=n.httpMethod,a=n.authentication,s=n.rawResponse,u=g({f:"json"},n.params),c={method:o,credentials:"same-origin"}
return(a?a.getToken(e,{fetch:n.fetch}).catch(function(t){throw t.url=e,t.options=n,t}):Promise.resolve("")).then(function(t){if(t.length&&(u.token=t),"GET"===c.method){var r=""===b(u)?e:e+"?"+b(u)
n.maxUrlLength&&r.length>n.maxUrlLength?c.method="POST":e=r}var i=new RegExp("/items/.+/updateResources").test(e)
return"POST"===c.method&&(c.body=function(e,t){var n=v(e)||t,r=y(e)
if(n){var i=new FormData
return Object.keys(r).forEach(function(e){if("undefined"!=typeof Blob&&r[e]instanceof Blob){var t=r.fileName||r[e].name||e
i.append(e,r[e],t)}else i.append(e,r[e])}),i}return b(e)}(u,i)),c.headers=g({},n.headers),"undefined"!=typeof window||c.headers.referer||(c.headers.referer=O),v(u)||i||(c.headers["Content-Type"]="application/x-www-form-urlencoded"),n.fetch(e,c)}).then(function(t){if(!t.ok){var r=t.status,i=t.statusText
throw new _(i,"HTTP "+r,t,e,n)}if(s)return t
switch(u.f){case"json":case"geojson":return t.json()
case"html":case"text":return t.text()
default:return t.blob()}}).then(function(t){return"json"!==u.f&&"geojson"!==u.f||s?t:function(e,t,n,r){if(e.code>=400){var i=e.message,o=e.code
throw new _(i,o,e,t,r)}if(e.error){var a=e.error,s=(i=a.message,o=a.code,a.messageCode),u=s||o||"UNKNOWN_ERROR_CODE"
if(498===o||499===o||"GWM_0003"===s||400===o&&"Unable to generate token."===i)throw new E(i,u,e,t,r)
throw new _(i,u,e,t,r)}if("failed"===e.status||"failure"===e.status){i=void 0,o="UNKNOWN_ERROR_CODE"
try{i=JSON.parse(e.statusMessage).message,o=JSON.parse(e.statusMessage).code}catch(t){i=e.statusMessage||e.message}throw new _(i,o,e,t,r)}return e}(t,e,0,n)})}function A(e){return"/"===(e=e.trim())[e.length-1]&&(e=e.slice(0,-1)),e}function T(e,t){var n=t.codedValues.find(function(t){return e===t.code})
return n?n.name:e}(x=w||(w={})).ArcGISRequestError="ArcGISRequestError",x.ArcGISAuthError="ArcGISAuthError"
var P={fetch:void 0}
function j(e){var t=[],n=[]
return e&&e.forEach(function(e,r){if(e.url){t.push(e.name||"dataset"+r)
var i=function(e){void 0===e&&(e={})
...
return t[r]="object"==typeof i?JSON.stringify(i):i,n},t),t}(e.query),o={url:e.url,params:i}
n.push((a=o,s=a,u=["where","objectIds","relationParam","time","distance","units","outFields","returnGeometry","maxAllowableOffset","geometryPrecision","outSR","gdbVersion","returnDistinctValues","returnIdsOnly","returnCountOnly","returnExtentOnly","orderByFields","groupByFieldsForStatistics","outStatistics","returnZ","returnM","multipatchOption","resultOffset","resultRecordCount","quantizationParameters","returnCentroid","resultType","historicMoment","returnTrueCurves","sqlFormat","returnExceededLimitFeatures"],c={httpMethod:"GET",params:g({where:"1=1",outFields:"*"},a.params)},(l=g({params:{}},c,s)).params=u.reduce(function(e,t){return(s[t]||"boolean"==typeof s[t])&&(e[t]=s[t]),e},l.params),f=["params","httpMethod","rawResponse","authentication","portal","fetch","maxUrlLength","headers"].reduce(function(e,t){return l[t]&&(e[t]=l[t]),e},{}),C(A(a.url)+"/query",f)).then(function(t){var n,r=e.domains,i=r&&Object.keys(r).map(function(e){return{name:e,domain:r[e]}})
if(i&&i.length>0){var a={url:o.url,queryResponse:t,fields:i,fetch:P.fetch}
return n=a,new Promise(function(e){if(!n.fields)return(t={url:n.url},C(A(t.url),t)).then(function(t){e(n.fields=t.fields)})
var t
e(n.fields)}).then(function(e){var t=e.reduce(function(e,t){var n=t.domain
return n&&"codedValue"===n.type&&(e[t.name]=n),e},{})
if(Object.keys(t).length<1)return n.queryResponse
var r=n.queryResponse.features.map(function(e){var n={}
for(var r in e.attributes)if(e.attributes.hasOwnProperty(r)){var i=e.attributes[r],o=t[r]
n[r]=null!==i&&o?T(i,o):i}return g({},e,{attributes:n})})
return g({},n.queryResponse,{features:r})})}return t}))}var a,s,u,c,l,f}),Promise.all(n).then(function(e){var n=e.reduce(function(e,n,r){return e[t[r]]=n,e},{})
return Promise.resolve(n)})}var R=function(){function e(e,t){if(!e)throw new Error("A container is required")
var n
...
return n&&n.some(function(n){if(n.name===e)return t=n,!0}),t},e.prototype.query=function(){return j(this.datasets())},e.prototype.updateData=function(e){var t=this.datasets(),n={datasetsData:e,series:this.series()}
return this._data=function(e,t){if(e){if(e.length<1)return[]
var n,r=t&&t.datasetsData
if(e.length>1){var i=t&&t.series
return o=i,a=r,s=e.reduce(function(e,t,n){var r,i=t.join,s=d(t,a),u=t.name,c=(r=u,o.reduce(function(e,t){return t.source===r&&t.value&&e.push(t.value.field),e},[]))
return p(s).forEach(function(t){var n=h(t),r=n[i]
void 0===e[r]&&(e[r]={categoryField:r}),c.reduce(function(e,t){return e[u+"_"+t]=n[t],e},e[r])}),e},{}),Object.keys(s).map(function(e){return s[e]})}return(n=p(d(e[0],r,"dataset0"))).length>0&&n[0].attributes?n.map(h):n}var o,a,s}(t,n),this},e.prototype.render=function(){return function(e,t,n){if((!e||!t||!n)&&t.type&&"custom"!==t.type)throw new Error("Element Id, definition, and data are all required.")
if(t.type&&"custom"===t.type)return f(e,t)
f(e,t,n)}(this._container,this.definition(),this.data()),this},e.prototype.show=function(){var e=this
...
e.Chart=R,Object.defineProperty(e,"__esModule",{value:!0})}(t)}}])
var __ember_auto_import__=function(e){function t(t){for(var r,a,s=t[0],u=t[1],c=t[2],f=0,p=[];f<s.length;f++)a=s[f],i[a]&&p.push(i[a][0]),i[a]=0
...
"undefined"!=typeof document&&(n.p=(r=document.querySelectorAll("script"))[r.length-1].src.replace(/\/[^\/]*$/,"/")),e.exports=(i=_eai_d,o=_eai_r,window.emberAutoImportDynamic=function(e){return o("_eai_dyn_"+e)},void i("@esri/cedar",[],function(){return n(3)}))}])
